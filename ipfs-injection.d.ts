...
export declare type FileContent = Object | Blob | string;
...
export declare class PeersOptions {
    v?: boolean;
    verbose?: boolean;
}
...
export declare type Obj = BufferSource | Object;
export declare class ObjectStat {
    Hash: Multihash;
    NumLinks: number;
    BlockSize: number;
    LinksSize: number;
...
export declare class PutObjectOptions {
    enc?: any;
}
export declare class GetObjectOptions {
    enc?: any;
}
...
export declare const IPFS: InjectionToken<IPFS>;
export declare const IPFS_NODE_READY: InjectionToken<IPFS>;
